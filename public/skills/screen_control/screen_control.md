...
when_to_use:
  MUST HAVE BOTH:
  1. **ACTION VERB** (必須有動詞):
     English: "fullscreen", "full screen", "enter fullscreen", "exit fullscreen", "quit fullscreen", "leave fullscreen", "toggle fullscreen", "no more screen", "normal screen"
...
examples_CORRECT_fullscreen:
  ...
  - "no more screen" ✓ (verb: no more, intent: exit fullscreen)
  - "normal screen" ✓ (verb: normal, intent: exit fullscreen)
...
intent_examples:
  CORRECT - call this skill (HAS fullscreen verb):
    ...
    - "no more screen" → Call screen_control with mode: "exit"
    - "normal screen" → Call screen_control with mode: "exit"
...
- Map user input to mode:
  ...
  * "exit", "quit", "leave", "no more screen", "normal screen", "退出全螢幕", "退出", "離開" → "exit"
  * "toggle" → "toggle"
...
- User says "no more screen" → {"skill": "screen_control", "args": {"mode": "exit", "prompt": "no more screen"}}
- User says "normal screen" → {"skill": "screen_control", "args": {"mode": "exit", "prompt": "normal screen"}}
